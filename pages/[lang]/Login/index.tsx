...
export default function Login() {
  ...
  const { language, setLanguage, translation, setTranslation } =
    useContext(Context);
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="SoSa Anime" />
        ...
        <div className="bg-black bg-opacity-75 flex justify-around items-center w-full h-full max-md:flex-col">
          ...
          >
            <span
              aria-hidden="true"
              style={{
                backgroundImage: switchLang
                  ? "url(/assets/brIcon.png)"
                  : "url(/assets/euaIcon.png)",
              }}
              className={`${
                switchLang ? "translate-x-8" : "translate-x-0"
              } bg-center bg-contain pointer-events-none 
          ...
          />
          <div
            className="bg-black rounded-2xl p-10 flex flex-col items-center gap-5 border-2 border-[#111111]
