  ...
  return (
    <div>
      ...
      <div className="relative AnimeRow">
        <div
          className="absolute left-0 top-1/2 transform -translate-y-1/2 cursor-pointer Arrow bg-gradient-to-r from-black/50 to-black/25 transition-all duration-500 rounded-r-2xl p-5"
          onClick={leftArrowHandle}
        >
          <SlArrowLeft style={{ fontSize: "40" }} />
        </div>
        <div
          className="absolute right-0 top-1/2 transform -translate-y-1/2 cursor-pointer Arrow bg-gradient-to-l from-black/75 to-black/25 transition-all duration-500 rounded-l-2xl p-5"
